...
if(isset($_POST["submit"])){
  ...
  if(mysqli_num_rows($result) > 0){
    if($password == $row['password']){
      ...
      echo
      "<script> alert('Parolă incorectă'); </script>";
    }
  }
  else{
    echo
    "<script> alert('Utilizatorul nu este înregistrat'); </script>";
  }
}
?>
<!DOCTYPE html>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
        ...
        <a href="register.php" class="btn btn-primary dropdown-toggle sign-up-btn">Sign up</a>
      ...
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="card cascading-right" style="
          ...
          <div class="card-body p-5 shadow-5 text-center">
            <h2 class="fw-bold mb-5">Loghează-te</h2>
            <form class="" action="" method="post" autocomplete="off">
            <!-- Email sau Username -->
			   <div class="form-outline mb-4">
                <input type="text" name="usernameemail" id="usernameemail" required value="" class="form-control" />
                <label class="form-label" for="usernameemail">Email sau Username</label>
              </div>
              <!-- Password input -->
              <div class="form-outline mb-4">
