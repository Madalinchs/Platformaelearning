...
<div class="card" style="width: 26rem;">
  ...
  <div class="card-body">
    ...
    <a href="detaliiaz-900.php" class="btn btn-primary" style="margin-left:70px">Detalii curs</a>
	<a href="cursaz-900.php" class="btn btn-primary" >Accesează curs</a>
...
<div class="card" style="width: 26rem;">
  ...
  <div class="card-body">
    ...
    <a href="detaliiaz-104.php" class="btn btn-primary" style="margin-left:70px">Detalii curs</a>
	<a href="cursaz-104.php" class="btn btn-primary" >Accesează curs</a>
  </div>
</div>
</div>
<div class="col-lg-4 mb-4">
<div class="card" style="width: 26rem;">
  ...
  <div class="card-body">
    ...
    <a href="detaliiaz-700.php" class="btn btn-primary" style="margin-left:70px">Detalii curs</a>
	<a href="cursaz-700.php" class="btn btn-primary" >Accesează curs</a>
  </div>
  </div>
</div>
</div>
