...
if(isset($_POST["submit"])){
  ...
  if(mysqli_num_rows($duplicate) > 0){
    echo
    "<script> alert('Utilizator sau email deja folosite!'); </script>";
  }
  else{
    if($password == $confirmpassword){
      ...
      echo
      "<script> alert('Utilizator înregistrat cu succes!'); </script>";
    }
    else{
      echo
...
$(document).on("click", ".action-buttons .dropdown-menu", function(e){
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
        ...
        <a href="login.php" class="btn btn-primary dropdown-toggle sign-up-btn">Login</a>
...
<section class="text-center text-lg-start">
  ...
  <div class="container py-4">
    <div class="row g-0 align-items-center">
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="card cascading-right" style="
          ...
          <div class="card-body p-5 shadow-5 text-center">
            <h2 class="fw-bold mb-5">Creează cont nou</h2>
            ...
            <!-- Nume și prenume -->
			  ...
			  <div class="form-outline mb-4">
                <input type="password" name="confirmpassword" id="confirmpassword" required value="" class="form-control" />
                <label class="form-label" for="confirmpassword">Confirmă Parola</label>
              </div>
              <!-- Submit button -->
      ...
      <div class="col-lg-6 mb-5 mb-lg-0">
        <img src="images/carti.jpg" class="w-100 rounded-4 shadow-4"
          alt="" />
      </div>
    </div>
  </div>
